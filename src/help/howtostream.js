            ...
            <div className="slds-col--padded slds-size--12-of-12 slds-medium-size--8-of-12 slds-large-size--8-of-12 comm-layout-column">
              <div className="slds-rich-text-editor__output uiOutputRichText forceOutputRichText cKnowledgeArticle">
                ...
                <div className="bounding">
                  <p className="help-mg-b-12">Here are the guide lines for streaming on AngelThump.</p>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="help-mg-b-12">
                      On your OBS, click settings and go to output to enter your settings using the provided guidelines up top. 
                      Please make sure your Keyframe interval is set to 2.
                    </p>
                  </div>
                </div>
              </div>
